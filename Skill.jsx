...
const developmentTools = [
  ...
  { imgSrc: '/images/hadoop.svg', label: 'Apache Hadoop', desc: 'Big Data Framework' }, 
  { imgSrc: '/images/apachesparkpng.png', label: 'Apache Spark', desc: 'Big Data Processing' }, 
  { imgSrc: '/images/elasticsearch.svg', label: 'Elasticsearch', desc: 'Data Search & Analytics' }
];
...
const dataAnalysisTools = [
  ...
  { imgSrc: '/images/eviews.jpg', label: 'EViews', desc: 'Econometric Analysis' }, 
  { imgSrc: '/images/minitab.png', label: 'Minitab', desc: 'Statistical Analysis' }, 
  { imgSrc: '/images/looker.svg', label: 'Looker Studio', desc: 'Data Visualization' },
  { imgSrc: '/images/arcgis.png', label: 'ArcGIS', desc: 'Geospatial Analysis' } 
];
