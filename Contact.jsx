...
const socialLinks = [
  {
    href: 'https://github.com/EraNusaData',
  ...
  icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 0C5.37125 0 0 5.37125 0 12C0 18.6288 5.37125 24 12 24C18.6288 24 24 18.6288 24 12C24 5.37125 18.6288 0 12 0ZM17.3562 17.2031C16.9688 17.775 16.2788 17.9331 15.7281 17.6006C13.1081 15.9788 9.77125 15.6187 5.99625 16.5938C5.39375 16.7531 4.78125 16.3913 4.62187 15.7888C4.4625 15.1862 4.82375 14.5737 5.42625 14.4144C9.80438 13.2625 13.6688 13.7 16.7281 15.5981C17.2788 15.9406 17.7375 16.6312 17.3562 17.2031ZM18.7875 13.8531C18.315 14.5531 17.3762 14.7656 16.6688 14.3031C13.6406 12.3562 8.77375 11.9781 5.33438 13.2531C4.55125 13.5531 3.69375 13.1406 3.39375 12.3575C3.09375 11.5737 3.50625 10.7156 4.29 10.4156C8.40937 8.83438 13.9031 9.25312 17.4781 11.5981C18.1781 12.0594 19.26 13.1531 18.7875 13.8531ZM18.9981 10.15C15.1763 7.72687 8.64875 7.49625 4.96875 8.78562C4.095 9.09062 3.135 8.59687 2.83 7.72312C2.525 6.84937 3.01875 5.88937 3.8925 5.58437C8.27625 4.07312 15.5569 4.34063 20.1731 7.23562C21.0019 7.75125 21.26 8.83 20.7444 9.65812C20.2288 10.4862 19.15 10.7438 18.3219 10.2281L18.9981 10.15Z" fill="currentColor"/>
    </svg>
  ,
  alt: 'Spotify'
  },
  {
    href: 'https://www.instagram.com/eranusadata',
  ...
  {
  href: 'https://www.youtube.com/@eranusadata',
  icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M23.498 6.186a2.999 2.999 0 0 0-2.112-2.12C19.505 3.5 12 3.5 12 3.5s-7.505 0-9.386.566a2.999 2.999 0 0 0-2.112 2.12A31.229 31.229 0 0 0 0 12a31.229 31.229 0 0 0 .502 5.814 2.999 2.999 0 0 0 2.112 2.12C4.495 20.5 12 20.5 12 20.5s7.505 0 9.386-.566a2.999 2.999 0 0 0 2.112-2.12A31.229 31.229 0 0 0 24 12a31.229 31.229 0 0 0-.502-5.814ZM9.75 15.02V8.98L15.5 12l-5.75 3.02Z" fill="currentColor"/>
    </svg>,
  alt: 'YouTube'
  }
];
